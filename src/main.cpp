  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    if (showDebugGUI) {
      ...
      ImGui::DragFloat3("Uri Scale", &urinarioScale.x, 0.01f, 0.05f,
                        2.0f); // los parametros de dragfloat3 son name, escalas
                               // y posicion inicial
      ImGui::Separator();
      ImGui::Text("Bano 2");
      ...
      ImGui::DragFloat3("Lampara bano Rot", &ligthbathroomRot.x, 0.5f, -180.0f,
                        180.0f);
      ...
      ImGui::Text("Sillas - 2");
      ImGui::DragFloat3("Sillas 2 Pos", &sillas2Pos.x, 0.05f, -100.0f, 100.0f);
      ImGui::DragFloat3("Sillas 2 Rot", &sillas2Rot.x, 0.5f, -180.0f, 180.0f);
      ImGui::DragFloat3("Sillas 2 Scale", &sillas2Scale.x, 0.01f, 0.001f, 3.0f);
      ImGui::Separator();

      ImGui::Text("Sillas - Fila Ext. Derecha (3)");
      ImGui::DragFloat3("Sillas 3 Pos", &sillas3Pos.x, 0.05f, -100.0f, 100.0f);
      ImGui::DragFloat3("Sillas 3 Rot", &sillas3Rot.x, 0.5f, -180.0f, 180.0f);
      ImGui::DragFloat3("Sillas 3 Scale", &sillas3Scale.x, 0.01f, 0.001f, 3.0f);
      ImGui::Separator();

      ImGui::Text("Sillas - Fila Ext. Izquierda (4)");
      ImGui::DragFloat3("Sillas 4 Pos", &sillas4Pos.x, 0.05f, -100.0f, 100.0f);
      ...
      ImGui::DragFloat3("ReactorCtrl Rot", &reactorControlRot.x, 0.5f, -180.0f,
                        180.0f);
      ...
      ImGui::DragFloat3("LamparaR Rot", &lamparaReactorRot.x, 0.5f, -180.0f,
                        180.0f);
      ImGui::DragFloat3("LamparaR Scale", &lamparaReactorScale.x, 0.01f, 0.01f,
                        10.0f);
      ...
      const char *generadorItems[] = {"Generador 1", "Generador 2",
                                      "Generador 3"};
      ImGui::Combo("Seleccionar Generador", &selectedGenerador, generadorItems,
                   IM_ARRAYSIZE(generadorItems));
      ...
      ImGui::Combo("Seleccionar Esquinero", &selectedEsquinero, esquineroItems,
                   IM_ARRAYSIZE(esquineroItems));
      ...
      if (gameEntities.empty()) {
        ...
        std::string exportLine = "{glm::vec3(" +
                                 std::to_string(selectedEntity.pos.x) + "f, " +
      ...
      if (showInteractionDebugger) {
        ...
        ImGui::Begin("Interaction Debugger", NULL,
                     ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);
        ImGui::Text("Camara dir: %.2f %.2f %.2f", cameraFront.x, cameraFront.y,
                    cameraFront.z);
        ImGui::Separator();
