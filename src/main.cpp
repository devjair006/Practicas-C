...
int main() {
  ...
  GLTFModel *literaGLTF = new GLTFModel(
      "assets/descanso/litera.glb"); // archivo pendiente de agregar
  GLTFModel *lockerGLTF = new GLTFModel(
      "assets/descanso/locker.glb"); // archivo pendiente de agregar
  GLTFModel *extintorGLTF = new GLTFModel(
      "assets/descanso/extintor.glb"); // archivo pendiente de agregar
  GLTFModel *botiquinGLTF = new GLTFModel(
      "assets/descanso/botiquin.glb"); // archivo pendiente de agregar
